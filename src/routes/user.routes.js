...
router.post("/v1/users/:userID/favorites/:recipeID", UserController.addFavorite);
router.put("/v1/users/:userID/favorites/:recipeID", UserController.updateFavorite);
router.delete("/v1/users/:userID/favorites/:recipeID", UserController.deleteFavorite);
